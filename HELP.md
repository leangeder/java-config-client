...
* The original package name 'uk.co.underwriteme.ruleengine.config-client' is invalid and this project uses 'uk.co.underwriteme.ruleengine.configclient' instead.
